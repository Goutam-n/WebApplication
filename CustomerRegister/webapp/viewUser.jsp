...
<div class="container">
    <div class="table-wrapper">
        ...
        <%
            ...
            List<CustomerDto> listOfUsers = udao.getAllUserData();
            Iterator<CustomerDto> itr = listOfUsers.iterator();
        %>
        <table width="1200" class="table table-bordered">

            <thead>
            <tr>
                <th><strong>PartyID </strong></th>
            ...
            <%
                while(itr.hasNext())
                {
                    CustomerDto user = itr.next();
            %>
            <tbody>
            <tr>
                <td><strong><%=user.getPartyId()%></strong></td>
